...
import { Home, MessageSquare, Gamepad2, BookOpen, Music, FileText, PenTool, BookMarked, LayoutDashboard, Target, Mic, LogOut, Globe, Menu, X } from 'lucide-react';
...
const navItems = [
  ...
  { id: '4skills' as Page, icon: Target, label: '4 Skills', labelMY: '4 Kemahiran', labelTA: '4 திறன்கள்', labelZH: '4项技能' },
