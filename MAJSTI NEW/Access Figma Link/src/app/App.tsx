...
import { FourSkills } from './components/FourSkills';
import { AIDoubtCorner } from './components/AIDoubtCorner';

export type Page = 'home' | 'forum' | 'games' | 'dictionary' | 'music' | 'tests' | 'essay' | 'literature' | 'teacher' | 'debate' | 'pronunciation' | '4skills';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        {currentPage === '4skills' && <FourSkills language={language} user={user} />}
      </main>

      {/* AI Doubt Corner - Available on all pages */}
      <AIDoubtCorner language={language} />
    </div>
  );
}